            ...
            <form method="GET" action="calcinhas.php" class="mb-4">
                <div class="form-row">
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <input type="number" name="preco_min" id="preco_min" step="0.01" value="<?php echo htmlspecialchars($preco_min); ?>" class="form-control">
                    </div>
                    <div class="form-group col-md-3">
                        <label for="preco_max">Preço Máximo:</label>
                        <input type="number" name="preco_max" id="preco_max" step="0.01" value="<?php echo htmlspecialchars($preco_max); ?>" class="form-control">
                    </div>
                    <div class="form-group col-md-3">
